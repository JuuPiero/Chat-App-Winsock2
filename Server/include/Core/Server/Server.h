...
private:
    ...
    void OnUserLogout(uint32_t clientSocketId, std::string& username, std::string& password);
    void OnUserSignup(uint32_t clientSocketId, std::string username, std::string password);
    ...
    void OnUserGetConversation(uint32_t clientSocketId, int userId, int conversationId);
    ...
    void OnUserLeftGroupChat(uint32_t clientSocketId, int userId, int conversationId);
